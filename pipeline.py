...
def main():
    ...
    # Original ECG
    # ECG-only Grad-CAM
    # BioBERT + RAG K=3 Grad-CAM
    # BioBERT + RAG K=3 Score-CAM
    # ===========================================
    ...
    rag_sc = ECGGradCAM(rag_model, rag_target_layer, max_channels=32)
    with torch.no_grad():
    ...
    overlay_cam_on_ecg(
        ...
        ecg_1d,
        rag_scorecam,
        title="BioBERT + RAG (K=3) Grad-CAM",
        pred_label=rag_pred,
        true_label=true_label
    )

    plt.savefig(
        "mimic_explainability_panel_new.png",
        dpi=600,
        bbox_inches="tight",
        facecolor="white"
    )
    plt.savefig(
        "mimic_explainability_panel_new.pdf",
        bbox_inches="tight",
        facecolor="white"
    )
    ...
    print("Saved final figure to mimic_explainability_panel_new.png and .pdf")
    ...
    # print("Saved final figure to mimic_explainability_panell_neww.png")
    # print("Retrieved reports for this sample:")
    # for i, rr in enumerate(retrieved_reports, 1):
    #     print(f"[{i}] {rr}")
